...
import { ArrowDownUp, Frown } from 'lucide-react';
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Avatar className="w-8 h-8 rounded-full cursor-pointer group">
                        ...
                        />
                        <AvatarFallback className="w-full h-full text-xs flex items-center justify-center group-hover:opacity-80 transition-opacity ease-in-out duration-30">
